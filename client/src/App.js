...
function App() {
  ...
  return (
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path='/userbookings' element={<UserBookings/>} />      
            <Route path="/addcar" element={isAuthenticatedUser ?<AddCar />:  <SellerLogin/>}  />
      ...
      <Route path="/sellerUser/:id/verify/:token" element={<EmailVerify2 />} />
      ...
      <Route path="/forgot-password-seller" element={<ForgotPassword1 />} />
			...
			<Route path="/password-reset-user/:id/user/:token" element={<PasswordReset />} />
			<Route path="/password-reset-seller/:id/seller/:token" element={<PasswordReset1 />} />
			<Route path="/password-reset-admin/:id/admin/token" element={<PasswordReset2 />} />
      ...
      {/* <Route path="/red"  element={isAuthenticatedUser ?<Red />:  <Login/>} /> */}
    		<Route path="/afterHome" exact element={isseller ?<Home />:  <AfterHome/>}  />
